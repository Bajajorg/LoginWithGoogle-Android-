...
public class SignInActivity extends AppCompatActivity implements
    ...
    private void updateUI(boolean signedIn) {
        if (signedIn) {
            ...
            hashMap.put("id", acct.getId());
            hashMap.put("name", acct.getDisplayName());
            hashMap.put("profile_pic_url", acct.getPhotoUrl().toString());
            Intent intentProfileInfo = new Intent(SignInActivity.this, ShowProfileInformation.class);
            intentProfileInfo.putExtra("hashMap", hashMap);
            startActivityForResult(intentProfileInfo, 2);
        } else {
